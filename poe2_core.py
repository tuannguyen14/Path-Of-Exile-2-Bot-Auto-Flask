...
class AutoManager:
    """
    Auto HP/Mana flask based on percentage with hysteresis and random cooldown.
    ...
    def __init__(self, mem: MemoryReader):
        ...
        self._armed: dict[str, bool] = {"hp_flask": True, "mana_flask": True}
        self._running = False
    ...
    def _tick(self):
        ...
        if hp is not None and max_hp:
            ...
            if hp_pct >= HP_FLASK_RECOVERED:
                self._armed["hp_flask"] = True
            ...
            elif self._armed["hp_flask"] and hp_pct < HP_FLASK_THRESHOLD and self._ready("hp_flask"):
        ...
        if mana is not None and max_mana and max_mana > 0:
            ...
            if mana_pct >= MANA_FLASK_RECOVERED:
                self._armed["mana_flask"] = True

            if self._armed["mana_flask"] and mana_pct < MANA_FLASK_THRESHOLD and self._ready("mana_flask"):
